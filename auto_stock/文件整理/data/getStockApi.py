...
class StockData:
    ...
    def __init__(self, stock):
        self.stock = stock  # self.hist_data = ts.get_hist_data(self.stock,start=statTime)  # self.hist_data = self.hist_data.sort_index()
    ...
    def get_hist(self, num):
        ...
        return data  # return data1.to_json(orient='split')
    ...
    def get_hist_k(self):
        ...
        return json.dumps(data)  # print json.dumps(data)
    ...
    def get_all(self):
        ...
        return data.to_json(orient='split')  # 股票类型判断
    ...
    def getStockType(self, stock):
        ...
        if st == '600' or st == '601' or st == '603':
            return 'sh'  # typeList = ['600','601','603']
